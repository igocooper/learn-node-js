...
var _hearts = __webpack_require__(34);
...
function searchResultsHTML(stores) {
  var html = stores && stores.map(function (store) {
...
function typeAhead(search) {
  ...
  searchInput.on('input', function () {
    ...
    _axios2.default.get('/api/search?q=' + value).then(function (res) {
      if (res.data.length) {
      ...
      searchResults.innerHTML = _dompurify2.default.sanitize('<div class="search__result">No results for ' + value + ' found!</div> ');
    });
  });
...
function loadPlaces(map) {
  ...
  _axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng).then(function (res) {
    ...
    // show info details when someone click on the marker
